...
public class ScheduleServiceImpl implements ScheduleService {
	...
	@Override
	public movieSchedule saveSchedule(movieSchedule movieSchedule)  throws RuntimeException {
...
//		parkingSlotRepository.save(null)
	...
	@Override
	public List<movieSchedule> getScheduleByDate(String date) throws RuntimeException{
...
//				.orElseThrow(() -> new ResourceNotFoundException("no movie shedule avaliable for date" + date));
	...
	@Override
	public movieSchedule getScheduleBydateAndTime(String date, String time) throws RuntimeException {
