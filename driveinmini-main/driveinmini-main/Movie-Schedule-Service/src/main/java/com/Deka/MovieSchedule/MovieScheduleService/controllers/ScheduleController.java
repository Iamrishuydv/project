...
public class ScheduleController {
	...
	// create
	@PostMapping("/addshow")
	public ResponseEntity<?> createMovieSchedule(@Valid @RequestBody movieSchedule movieSchedule,BindingResult bindingResult) throws RuntimeException {
	...
	@GetMapping("/{date}")
	public ResponseEntity<?> singleMovieScheduleByDate( @PathVariable String date) throws RuntimeException{
